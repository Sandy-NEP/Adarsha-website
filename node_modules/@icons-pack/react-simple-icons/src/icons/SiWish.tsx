    ...
    type SiWishProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiWish: IconType = React.forwardRef<SVGSVGElement, SiWishProps>(function SiWish({title = 'Wish', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
