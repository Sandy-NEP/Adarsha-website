    ...
    type SiCitroenProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCitroen: IconType = React.forwardRef<SVGSVGElement, SiCitroenProps>(function SiCitroen({title = 'Citroën', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
