    ...
    type SiAffinityphotoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#7E4DD2';

    const SiAffinityphoto: IconType = React.forwardRef<SVGSVGElement, SiAffinityphotoProps>(function SiAffinityphoto({title = 'Affinity Photo', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAffinityphoto as default, defaultColor };
