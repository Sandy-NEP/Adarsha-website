    ...
    type SiRevolutProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiRevolut: IconType = React.forwardRef<SVGSVGElement, SiRevolutProps>(function SiRevolut({title = 'Revolut', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
