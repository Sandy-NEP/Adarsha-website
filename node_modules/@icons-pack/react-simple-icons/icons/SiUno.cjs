...
const SiUno = React__namespace.forwardRef(function SiUno2({ title = "Uno", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
