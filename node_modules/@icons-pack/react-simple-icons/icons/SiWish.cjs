...
const defaultColor = "#2FB7EC";
const SiWish = React__namespace.forwardRef(function SiWish2({ title = "Wish", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
