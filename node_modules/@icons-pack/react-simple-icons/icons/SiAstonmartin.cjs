...
const SiAstonmartin = React__namespace.forwardRef(function SiAstonmartin2({ title = "Aston Martin", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
