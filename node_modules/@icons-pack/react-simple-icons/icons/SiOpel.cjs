...
const SiOpel = React__namespace.forwardRef(function SiOpel2({ title = "Opel", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
