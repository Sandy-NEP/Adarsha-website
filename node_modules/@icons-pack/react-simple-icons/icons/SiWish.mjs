...
const SiWish = React.forwardRef(function SiWish2({ title = "Wish", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
