...
const defaultColor = "#0075EB";
const SiRevolut = React__namespace.forwardRef(function SiRevolut2({ title = "Revolut", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
